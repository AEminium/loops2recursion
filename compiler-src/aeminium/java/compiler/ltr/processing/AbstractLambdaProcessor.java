...
public abstract class AbstractLambdaProcessor<T extends CtElement>  extends AbstractProcessor<T>{
	...
	protected String checkAndGenerateExpr(CtElement expr, String[] input_vars) {
		/* TODO
		WhileToRecVisitor gen = new WhileToRecVisitor(getEnvironment(), input_vars, expr);
		expr.accept(gen);
